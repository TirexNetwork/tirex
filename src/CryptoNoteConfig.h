...
namespace cn
{
	namespace parameters
	{
		...
		const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x7c9d; /* ccx7 address prefix */
		...
		const uint64_t MONEY_SUPPLY = UINT64_C(199999999000000); /* max supply: 200M (Consensus II) */
		...
		const uint64_t MINIMUM_FEE = UINT64_C(10);			  /* 0.000010 TRX */
		const uint64_t MINIMUM_FEE_V1 = UINT64_C(100);		  /* 0.000100 TRX */
		const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000);		  /* 0.001000 TRX */
		const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000);  /* 0.001000 TRX */
		const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 TRX */
	...
	const uint64_t FOUNDATION_TRUST = (UINT64_C(9950000) * parameters::COIN); // locked funds to secure network  (Consensus II)
	...
	const uint64_t REWARD_INCREASE_INTERVAL = (UINT64_C(21900));			   // aprox. 1 month (+ 0.25 TRX increment per month)

	const char CRYPTONOTE_NAME[] = "tirex";
	const char GENESIS_COINBASE_TX_HEX[] = "010a01ff0001c096b102029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd088071210135abdc2b4b9234c7dc817411f0a71226769772e7bd9af9f898433cab7f0165ec";
	...
	const std::initializer_list<const char *> SEED_NODES = {
		"45.82.68.116:18888", // NL
		"85.209.90.133:18888"	 // NL
	};
